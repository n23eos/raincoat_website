...
(function(){
  ...
  var DICT = {
    ...
    "prod.mafia.fact": "Пульт ведущего · трекер партии · дедукция",
    "prod.mafia.text": "Кто против кого голосовал, кого проверил шериф, чья версия не сходится? Собрал помощника для мафии: веди партию, фиксируй голоса и проверки, а между играми тренируй дедукцию. Всё сохраняется в браузере.",
    ...
    /* страница /hire */
    "hire.meta.title": "Nikolai Menzhiliy - независимый разработчик",
    "hire.meta.desc": "Проектный опыт Nikolai Menzhiliy: Python, AI-инструменты и HTML5-игры для браузера.",
    "hire.label": "Для рекрутеров и команд",
    "hire.h1": "Nikolai Menzhiliy - независимый разработчик",
    "hire.lede": "Проектный опыт в Python, AI-инструментах и HTML5-играх для браузера. Ищу junior/associate роль с полной удалёнкой из Батуми, Грузия (UTC+4).",
    ...
    "hire.what2": "<strong>Веб:</strong> TypeScript/JavaScript, API, HTML5/Canvas и Three.js.",
    "hire.what3": "<strong>Игры:</strong> браузерные HTML5-проекты с публичными сборками.",
    "hire.what4": "<strong>Практика разработки:</strong> pytest, Git и работа с открытыми репозиториями.",
    "hire.stackH": "Стек",
    "hire.proofH": "Доказательства",
    "hire.proof1": "Публичный репозиторий Python-приложения для локальной диктовки и AI-обработки текста",
    "hire.proof2": "Python CLI: сравнение изменений промптов по метрикам, возобновляемые запуски и отчёты",
    "hire.proof3": "Работающая браузерная HTML5-игра",
    "hire.proof4": "Колончатая навигация по файлам Obsidian: исходный код и инструкции по использованию",
    "hire.proof5": "Другие публичные проектные работы",
    "hire.formatH": "Формат работы",
    "hire.format1": "Ищу junior/associate роль с полной удалёнкой из Батуми, Грузия (UTC+4).",
    "hire.format2": "Языки: русский, английский.",
    "hire.format3": "Открыт к работе в команде с общими задачами, обратной связью и code review.",
    "hire.ctaP": "Если мой проектный опыт подходит вашей команде, буду рад обсудить роль.",
    ...
    "prod.mafia.fact": "Host controls · game tracker · deduction",
    "prod.mafia.text": "Who voted against whom? Who did the sheriff check? Whose story doesn’t add up? I built a Mafia companion: host a game, track votes and checks, and practise deduction between games. Everything is saved in your browser.",
    "prod.kaidzen.fact": "Multi-agent · research loop",
    ...
    /* страница /hire */
    "hire.meta.title": "Nikolai Menzhiliy - Independent Developer",
    "hire.meta.desc": "Project-based experience in Python, AI tools and HTML5 browser games.",
    "hire.label": "For recruiters and teams",
    "hire.h1": "Nikolai Menzhiliy - Independent Developer",
    "hire.lede": "Project-based experience in Python, AI tools and HTML5 browser games. Seeking junior/associate fully remote roles from Batumi, Georgia (UTC+4).",
    ...
    "hire.what2": "<strong>Web:</strong> TypeScript/JavaScript, APIs, HTML5/Canvas and Three.js.",
    "hire.what3": "<strong>Games:</strong> browser-based HTML5 projects with public builds.",
    "hire.what4": "<strong>Development practice:</strong> pytest, Git and work in public repositories.",
    "hire.stackH": "Stack",
    "hire.proofH": "Proof",
    "hire.proof1": "Public repository for a Python local dictation app with AI text processing",
    "hire.proof2": "Python CLI with metric-gated prompt changes, resumable runs and reports",
    "hire.proof3": "A working HTML5 browser game",
    "hire.proof4": "Column-based file navigation for Obsidian, with source code and usage documentation",
    "hire.proof5": "Other public project work",
    "hire.formatH": "Work format",
    "hire.format1": "Seeking a junior/associate fully remote role from Batumi, Georgia (UTC+4).",
    "hire.format2": "Languages: Russian, English.",
    "hire.format3": "Open to teamwork with shared tasks, feedback and code review.",
    "hire.ctaP": "If my project experience fits your team, I would be glad to discuss the role.",
