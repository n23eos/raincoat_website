...
(function(){
  ...
  var DICT = {
    ru: {
    "nav.cases": "Проекты",
    "hero.heading": "AI Engineer",
    "hero.availability": "Ищу junior/associate роль · удалённо · Батуми, UTC+4",
    "hero.contact": "Обсудить роль →",
    "resume.download": "Резюме PDF ↓",
    "selected.float.text": "YouTube в окне поверх других приложений: видео, Shorts и управление воспроизведением.",
    "selected.iwh.text": "Бейджи за посещение событий на Base: QR-код, вход по email и получение NFT без оплаты газа гостем.",
    "selected.label": "Избранные работы",
    "selected.heading": "Продукты, которые я создаю",
    "selected.archive": "Весь архив →",
    "selected.read": "Сайт ↗",
    "selected.more": "Ещё работающие продукты",
    "selected.note": "Работающие приложения, расширения и инструменты. Открывайте сайт проекта или исходный код.",
    "selected.fs.text": "Диктовка для macOS с локальным распознаванием и настраиваемой обработкой текста.",
    "selected.fs.detail": "macOS · faster-whisper · LLM",
    "selected.agv.text": "Граф заметок Obsidian: WebGL-рендеринг, расчёт раскладки и анализ в отдельных Workers.",
    "selected.agv.detail": "Obsidian · WebGL · Web Workers",
    "selected.kaidzen.text": "Пайплайн исследования идей и сравнения промптов. Изменения проходят проверку по метрикам.",
    "selected.kaidzen.detail": "Агентный пайплайн · оценка качества",
    "showcase.obsidian": "Плагины Obsidian",
    "showcase.others": "Сайты, расширения и другие проекты",
    "showcase.type.plugin": "Плагин Obsidian",
    "showcase.type.extension": "Chrome-расширение",
    "showcase.type.webapp": "Веб-приложение",
    "showcase.type.games": "Игры",
    ...
    "workflow.try": "Открыть Kaidzen ↗",
    "contacts.copy": "AI-инструменты, агентные системы, интеграции и автоматизация. Пришлите описание роли или задачи, чтобы обсудить работу вместе.",
    "hire.contact": "Обсудить роль →",
    "hire.cases": "Смотреть проекты →",
    "hire.note": "Мой опыт основан на собственных продуктах. Ниже можно открыть работающие проекты и исходный код.",
    ...
    "hire.caseNote": "Сайты продуктов и открытый код.",
    ...
    "hero.sub": "Создаю AI-инструменты, агентные системы и автоматизацию. От интеграции моделей и инструментов до проверки результата и работающего продукта.",
    "hero.ctaProducts": "Смотреть проекты",
    ...
    "route.hireP": "AI Engineer: агентные системы, интеграции моделей и автоматизация. Проекты, исходный код и резюме.",
    ...
    /* обо мне */
    "about.label": "Обо мне",
    "about.text": "Я <strong>AI Engineer</strong>. Создаю инструменты с языковыми моделями, связываю агентов с API и автоматизирую процессы. В работе использую <strong>Python, TypeScript и MCP</strong>. Здесь собраны мои продукты и открытый код.",
    ...
    "selected.float.text": "YouTube above your other apps: videos, Shorts and playback controls.",
    "selected.iwh.text": "Event attendance badges on Base: scan a QR code, sign in by email and claim an NFT without paying gas.",
    "selected.label": "Selected work",
    "selected.heading": "Products I build",
    "selected.archive": "Full archive →",
    "selected.read": "Website ↗",
    "selected.more": "More working products",
    "selected.note": "Apps, extensions and tools. Open a project website or explore its source code.",
    ...
    "selected.kaidzen.detail": "Agent pipeline · evaluation",
    "showcase.obsidian": "Obsidian plugins",
    "showcase.others": "Websites, extensions and other projects",
    "showcase.type.plugin": "Obsidian plugin",
    "showcase.type.extension": "Chrome extension",
    "showcase.type.webapp": "Web app",
    "showcase.type.games": "Games",
    ...
    "workflow.try": "Explore Kaidzen ↗",
    "contacts.copy": "AI tools, agent systems, integrations and automation. Send a role or task description so we can discuss working together.",
    "hire.contact": "Discuss a role →",
    "hire.cases": "View projects →",
    "hire.note": "My experience comes from building my own products. Explore the working projects and source code below.",
    ...
    "hire.caseNote": "Product websites and source code.",
    ...
    "hero.sub": "I build AI tools, agent systems and automation, from model and tool integrations to evaluation and working products.",
    "hero.ctaProducts": "View projects",
    ...
    "route.hireP": "AI Engineer: agent systems, model integrations and automation. Projects, source code and resume.",
    ...
    /* обо мне */
    "about.label": "About",
    "about.text": "I am an <strong>AI Engineer</strong>. I build tools with language models, connect agents to APIs and automate workflows using <strong>Python, TypeScript and MCP</strong>. Here are my products and open-source projects.",
