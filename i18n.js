...
(function(){
  ...
  var DICT = {
    ru: {
    "nav.cases": "Кейсы",
    "hero.heading": "Python-разработка<br>и AI-инструменты",
    "hero.availability": "Ищу junior/associate роль · удалённо · Батуми, UTC+4",
    "hero.contact": "Обсудить роль →",
    "resume.download": "Резюме PDF ↓",
    "selected.label": "Избранные работы",
    "selected.heading": "Три задачи. Три разбора.",
    "selected.archive": "Весь архив →",
    "selected.read": "Разобрать кейс →",
    "selected.more": "Ещё работающие продукты",
    "selected.note": "В каждом разборе: задача, реализация, тестовые сценарии, ограничения и ссылки на исходный код.",
    "selected.fs.text": "Диктовка для macOS с локальным распознаванием и настраиваемой обработкой текста.",
    "selected.fs.detail": "В кейсе: границы приватности и поведение при ошибке модели.",
    "selected.agv.text": "Граф заметок Obsidian: WebGL-рендеринг, расчёт раскладки и анализ в отдельных Workers.",
    "selected.agv.detail": "В кейсе: разделение нагрузки и воспроизводимый бенчмарк.",
    "selected.kaidzen.text": "Пайплайн исследования идей и сравнения промптов. Изменения проходят проверку по метрикам.",
    "selected.kaidzen.detail": "В кейсе: почему красивого ответа недостаточно для принятия изменения.",
    "workflow.label": "Работа с AI",
    "workflow.heading": "Предложение агента проходит проверку",
    "workflow.intro": "На примере Kaidzen: человек выбирает задачу и ограничения, агенты исследуют варианты, а код проверяет основания для принятия изменений.",
    "workflow.1.title": "Задача и допущения",
    "workflow.1.body": "Analyzer выделяет рискованные допущения, которые нужно проверить.",
    "workflow.2.title": "Контекст и источники",
    "workflow.2.body": "Researcher ищет факты, а Refiner связывает правки с найденными основаниями.",
    "workflow.3.title": "Сравнение и проверки",
    "workflow.3.body": "Judge сравнивает варианты. Код проверяет метрики, регрессии и расход токенов.",
    "workflow.4.title": "Решение и отчёт",
    "workflow.4.body": "Изменение принимается или отклоняется. Сохранённый отчёт позволяет разобрать решение.",
    "workflow.proof": "Есть отдельный тест на случай, когда отчёт стал красивее, а доля закрытых критичных допущений ухудшилась.",
    "workflow.try": "Попробовать проверку →",
    "contacts.copy": "Python, AI-инструменты, интеграции и автоматизация. Пришлите описание роли или задачи, чтобы понять, где мой опыт будет полезен.",
    "hire.contact": "Обсудить роль →",
    "hire.cases": "Три инженерных разбора →",
    "hire.note": "Мой опыт основан на собственных проектах. На странице кейсов можно проверить решения, ограничения и исходный код.",
    "hire.tasksH": "С какими задачами могу помочь",
    "hire.task1": "Python-инструменты и интеграции с моделями: локальная обработка, API, обработка ошибок. Пример: FlowSpeech.",
    "hire.task2": "Автоматизация AI-процессов: сравнение вариантов, метрики качества, сохранение и продолжение запусков. Пример: Kaidzen.",
    "hire.task3": "Интерфейсы и инструменты для работы с данными: TypeScript, навигация, визуализация. Примеры: Column Explorer и Advanced Graph View.",
    "hire.caseNote": "Подробные разборы: устройство, принятые решения и ограничения.",
    "philo.accessible": "Интересы вне кода: философия, созерцательная практика, музыка и игры.",

    /* мета-теги */
    "meta.title": "Nikolai Menzhiliy | Python и AI-инструменты",
    "meta.desc": "Nikolai Menzhiliy: Python, AI-инструменты и автоматизация. Проектный опыт, исходный код и резюме. Junior/associate, удалённо из Батуми.",
    "meta.ogDesc": "Python и AI-инструменты: три инженерных разбора, открытый код и резюме Nikolai Menzhiliy.",
    ...
    "hero.sub": "Создаю приложения для диктовки, работы с заметками и автоматизации. Здесь можно посмотреть код, решения и ограничения моих проектов.",
    "hero.ctaProducts": "Посмотреть 3 кейса",
    ...
    "link.code": "Код",
    "prod.agv.fact": "Desktop · WebGL · beta",
    "prod.agv.text": "Граф заметок Obsidian: WebGL-рендеринг, расчёт раскладки и анализ в отдельных Workers.",
    ...
    "prod.kaidzen.fact": "Python · сравнение промптов · метрики",
    "prod.kaidzen.text": "Пайплайн исследования идей и сравнения промптов. Изменения проходят проверку по метрикам.",
    ...
    "prod.fs.fact": "macOS · локальный ASR · облако опционально",
    "prod.fs.text": "Диктовка для macOS: локальное распознавание, опциональные облачный ASR и LLM-очистка. Полностью локальный режим требует отключения облачных этапов.",
    ...
    "route.hireP": "Python, AI-инструменты и веб. Проектный опыт, исходный код и резюме. Ищу junior/associate роль с полной удалёнкой.",
    ...
    /* обо мне */
    "about.label": "Обо мне",
    "about.text": "Я Nikolai Menzhiliy, независимый разработчик. Работаю с <strong>Python, TypeScript и AI-инструментами</strong>: делаю приложения для себя и публикую исходный код. Ищу <strong>junior/associate роль</strong>, где смогу применять этот опыт, получать обратную связь и развиваться в команде.",
    ...
    "proj.graphView": "WebGL-граф Obsidian с отдельными Workers и бенчмарком.",
    ...
    "contacts.h2": "Обсудим работу в вашей команде",
    ...
    "case.iwashere.problem": "Получение бейджа усложняется, если гостю заранее нужны кошелёк, ETH и оплата газа.",
    ...
    "case.flowspeech.solution": "Распознавание через faster-whisper на устройстве; Groq ASR включается отдельно. Очистка через Claude / OpenAI / DeepSeek / Ollama либо без LLM. Облачные этапы отправляют соответствующие данные провайдеру; offline требует локальной модели и отключения облака.",
    ...
    "case.floatplayer.result": "<strong>Расширение с собственным лендингом.</strong> Окно поверх других окон, управление воспроизведением и режим Shorts.",
    ...
    "case.graphView.result": "<strong>Бенчмарк: 10 000 узлов, 30 000 рёбер, порог 50 FPS.</strong> Это критерий в bench/bench.ts, а не опубликованный замер на конкретном устройстве. Desktop beta.",
    ...
    "hero.heading": "Python development.<br>AI tools.",
    "hero.availability": "Seeking a junior/associate role · remote · Batumi, UTC+4",
    "hero.contact": "Discuss a role →",
    "resume.download": "Resume PDF ↓",
    "selected.label": "Selected work",
    "selected.heading": "Three problems. Three case studies.",
    "selected.archive": "Full archive →",
    "selected.read": "Read the case →",
    "selected.more": "More working products",
    "selected.note": "Each case covers the problem, implementation, test scenarios, limitations and source code.",
    "selected.fs.text": "Dictation for macOS with local speech recognition and configurable text processing.",
    "selected.fs.detail": "Inside: privacy boundaries and recovery from model errors.",
    "selected.agv.text": "An Obsidian notes graph with WebGL rendering, layout and analysis in separate Workers.",
    "selected.agv.detail": "Inside: workload separation and a reproducible benchmark.",
    "selected.kaidzen.text": "A pipeline for researching ideas and comparing prompts. Changes must pass metric checks.",
    "selected.kaidzen.detail": "Inside: why a polished answer is not enough to promote a change.",
    "workflow.label": "Working with AI",
    "workflow.heading": "An agent proposal has to pass checks",
    "workflow.intro": "Kaidzen is one example: a person chooses the task and constraints, agents explore alternatives, and code checks the grounds for accepting changes.",
    "workflow.1.title": "Task and assumptions",
    "workflow.1.body": "The Analyzer identifies risky assumptions that need checking.",
    "workflow.2.title": "Context and sources",
    "workflow.2.body": "The Researcher finds evidence. The Refiner ties changes to that evidence.",
    "workflow.3.title": "Comparison and checks",
    "workflow.3.body": "The Judge compares alternatives. Code checks metrics, regressions and token usage.",
    "workflow.4.title": "Decision and report",
    "workflow.4.body": "A change is accepted or rejected. A saved report makes the decision inspectable.",
    "workflow.proof": "A dedicated test rejects a prettier report when it closes a smaller share of critical assumptions.",
    "workflow.try": "Try the decision gate →",
    "contacts.copy": "Python, AI tools, integrations and automation. Send a role or task description so we can see where my experience fits.",
    "hire.contact": "Discuss a role →",
    "hire.cases": "Three engineering case studies →",
    "hire.note": "My experience comes from independent projects. The case studies document decisions, limitations and source code.",
    "hire.tasksH": "Tasks I can contribute to",
    "hire.task1": "Python tools and model integrations: local processing, APIs and error handling. Example: FlowSpeech.",
    "hire.task2": "AI workflow automation: comparing candidates, quality metrics, saving and resuming runs. Example: Kaidzen.",
    "hire.task3": "Interfaces and data tools: TypeScript, navigation and visualization. Examples: Column Explorer and Advanced Graph View.",
    "hire.caseNote": "Detailed case studies: implementation, decisions and limitations.",
    "philo.accessible": "Interests beyond code: philosophy, contemplative practice, music and games.",

    /* мета-теги */
    "meta.title": "Nikolai Menzhiliy | Python & AI tools",
    "meta.desc": "Nikolai Menzhiliy: Python, AI tools and automation. Project experience, source code and resume. Junior/associate, remote from Batumi.",
    "meta.ogDesc": "Python and AI tools: three engineering case studies, source code and Nikolai Menzhiliy's resume.",
    ...
    "hero.sub": "I build tools for dictation, working with notes and automation. Explore the code, design decisions and limitations of my projects.",
    "hero.ctaProducts": "Explore 3 case studies",
    ...
    "link.code": "Code",
    "prod.agv.fact": "Desktop · WebGL · beta",
    "prod.agv.text": "An Obsidian notes graph with WebGL rendering, layout and analysis in separate Workers.",
    ...
    "prod.kaidzen.fact": "Python · prompt comparison · metrics",
    "prod.kaidzen.text": "A pipeline for researching ideas and comparing prompts. Changes must pass metric checks.",
    ...
    "prod.fs.fact": "macOS · local ASR · optional cloud",
    "prod.fs.text": "Dictation for macOS: local recognition, optional cloud ASR and LLM cleanup. Fully local operation requires turning cloud stages off.",
    ...
    "route.hireP": "Python, AI tools and web development. Project experience, source code and resume. Seeking a fully remote junior/associate role.",
    ...
    /* обо мне */
    "about.label": "About",
    "about.text": "I am Nikolai Menzhiliy, an independent developer working with <strong>Python, TypeScript and AI tools</strong>. I build applications for my own use and publish the source code. I am looking for a <strong>junior/associate role</strong> where I can apply this experience, get feedback and grow within a team.",
    ...
    "proj.graphView": "An Obsidian WebGL graph with separate Workers and a benchmark.",
    ...
    "contacts.h2": "Let's discuss a role on your team",
    ...
    "case.iwashere.problem": "Claiming an event badge is harder when the guest first needs a wallet, ETH and a gas payment.",
    ...
    "case.flowspeech.solution": "On-device recognition with faster-whisper; Groq ASR is a separate option. Cleanup uses Claude / OpenAI / DeepSeek / Ollama, or no LLM. Cloud stages send their data to the selected provider; offline use requires a local model and cloud stages disabled.",
    ...
    "case.floatplayer.result": "<strong>An extension with its own landing page.</strong> An always-on-top window, playback controls and a Shorts mode.",
    ...
    "case.graphView.result": "<strong>Benchmark: 10,000 nodes, 30,000 edges, a 50 FPS threshold.</strong> This is the criterion in bench/bench.ts, not a published measurement on a specific device. Desktop beta.",
